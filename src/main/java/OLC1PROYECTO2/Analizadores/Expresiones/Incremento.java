...
public class Incremento extends Instrucciones {
    ...
    public Incremento(Instrucciones expresion, int linea, int columna) {
    ...
    public NodoAST getNodo() {
        NodoAST nodo = new NodoAST("INCREMENTO");
    ...
    public Object ejecutar(Arbol tree, TablaDeSimbolos table) {
        ...
        if (this.expresion.getTipo() == Tipo.tipos.INT) {
            ...
            valor = Double.parseDouble(valor.toString()) + 1;
             ...
             new Excepcion("Semántico", "Tipo no válido para incremento", this.linea, this.columna);
        }
